    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-gradient-to-br from-white to-gray-50 rounded-xl shadow-lg border border-[#f6aa1c]/20 overflow-hidden">
                <div class="p-8">
                    <div class="mb-8">
                        <h3 class="text-2xl font-bold text-[#220901]">Category Details</h3>
                        <p class="text-gray-600 mt-2">Fill in the information to add a new category.</p>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="slug" id="slug" value="{{ old('slug') }}"
                                    ...
                                    placeholder="e.g. traditional-rugs">
                                <p class="text-xs text-gray-500 mt-1">If left blank, it will be automatically generated from the name.</p>
                            </div>
                        </div>
